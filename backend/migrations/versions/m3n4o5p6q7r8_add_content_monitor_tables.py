...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("absolute_threshold", sa.BigInteger(), nullable=True),
        sa.Column("relative_threshold", sa.Float(), nullable=True),
        sa.Column("absolute_pass", sa.Boolean(), nullable=False, server_default=sa.false()),
        sa.Column("relative_pass", sa.Boolean(), nullable=False, server_default=sa.false()),
